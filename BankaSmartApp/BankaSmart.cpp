...
void mostrarMenuPrincipalTransacciones() {
...
int Mtransacciones() {
    ...
    do {
        mostrarMenuPrincipalTransacciones();
        cin >> opcionPrincipal;
...
void mostrarMenuPrincipal(){
    cout << "--Bienvenido a BankaSmart--\n";
    cout << "¿Que gestion deseas realizar?\n";
    cout << "1. Gestion de Cuentas.\n";
    cout << "2. Transacciones.\n";
    cout << "3. Prestamos.\n";
    cout << "4. Salir.\n";
}
int main()
{
    ...
    do{
        ...
        switch(opcionMenuPrincipal){
            ...
            case 4:
                cout << "Gracias por preferinos! Hasta la proxima.";
                break;
            default:
                cout << "Opcion invalida. Intenta de nuevo.\n";
                break;
